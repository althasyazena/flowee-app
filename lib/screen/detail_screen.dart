...
class _DetailScreenState extends State<DetailScreen> {
  ...
  /**
   * nilai ini 'hidup' selama widget state ini ada, 
   * setiap kali diubah oleh setstate (atau user nambahin jumlahnya) 
   * flutter akan melakuka rebuild agar tampilan ikut ter-update
   */
  int _quantity = 1;
